...
woods3 <- trans.armdata(study=studlab,treat1=treat1,treat2=treat2,n1=n1,n2=n2,y=TE,SE=seTE,measure="logHR",data=woods1)

print(woods3)		# "working" pseudo-dichotomoused data created under the proportional hazard assumption
